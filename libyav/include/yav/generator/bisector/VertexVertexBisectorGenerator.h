...
/** Generates a plane bisector between two vertex sites. */
class VertexVertexBisectorGenerator final : public AbstractBisectorGenerator
{
public:
    VertexVertexBisectorGenerator();
